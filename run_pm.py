...
stocks = ['KORI.PA', 'BKD', 'DVA', 'GEN', 'CSU', 'ADUS', 'ALK', '0293.HK', 'WIZZ.L', 'AF.PA', 'LHA.DE', 'CZR', '0308.HK', 'MAR', 'WYND', 'RCL', 'NCLH', 'DB', 'GS', 'SEB-A.ST', 'NDA-SE.ST', 'AMZN', 'FB', 'GOOG', 'AAPL', 'NFLX', 'MUV2.MI', 'CS.PA', 'ALV.DE', 'ING']
# remove fullstops
...
for i, row in enumerate(stocks):
    ...
    # only run for new stocks
    if sum(stock == df.symbol) == 0:
        try:
